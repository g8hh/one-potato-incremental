...
function updateMashedPotatoText() {
  ...
  document.getElementById("mashed_potatoes_info").innerHTML = "你有 "+numberFormat(mashed_potatoes)+" <span><img src='sprites/mashed_potato_icon.png' class='small_icon'></img></span>, 授予你一个奖励 "+numberFormat(Math.floor((((mashed_potatoes/100)+1)**3.2)*100)/100)+" x 到生长速度"
